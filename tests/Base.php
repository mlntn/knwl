...
class Base extends PHPUnit_Framework_TestCase {
  ...
  protected $str = 'This is a Knwl.js demo using a few of parser plugins. Click the \'parse\' button below to see the project in action.
...
I\'m sorry, I\'m extremely busy right now. I just looked at the clock, and it\'s 12:54 AM, I\'ve still got a lot of work to do.  Don\'t worry about 2016 event, it\'s been moved ahead a week, to the 28th of December. Remember though, you\'ve got to call to get a ticket soon. Their # is 212-323-1239, or call the toll free number 1 800 567-4321. They\'re based in Chicago, and their website says it costs $23 per person.
